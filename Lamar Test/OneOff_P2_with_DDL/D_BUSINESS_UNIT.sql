...
--   BUSINESS UNIT
--   ============= */
IF OBJECT_ID(N'Oracle_Reporting_P2.svo.D_BUSINESS_UNIT', 'U') IS NOT NULL
    DROP TABLE Oracle_Reporting_P2.svo.D_BUSINESS_UNIT;
GO


CREATE TABLE Oracle_Reporting_P2.svo.D_BUSINESS_UNIT
(
...
--  ON Oracle_Reporting_P2.svo.D_BUSINESS_UNIT (BUSINESS_UNIT_ID)
--  ON FG_SilverDim;
--GO

 
TRUNCATE TABLE Oracle_Reporting_P2.svo.D_BUSINESS_UNIT;
GO

SET IDENTITY_INSERT Oracle_Reporting_P2.svo.D_BUSINESS_UNIT ON;

INSERT INTO Oracle_Reporting_P2.svo.D_BUSINESS_UNIT
(
  BUSINESS_UNIT_SK,
  BUSINESS_UNIT_ID,
  BUSINESS_UNIT_NAME,
...
SET IDENTITY_INSERT Oracle_Reporting_P2.svo.D_BUSINESS_UNIT OFF;
...
FROM DW_BronzeSilver_PROD.bzo.CMN_BusinessUnitPVO;
GO
...
--      AND object_id = OBJECT_ID('Oracle_Reporting_P2.svo.D_BUSINESS_UNIT')
--)
--BEGIN
--    CREATE UNIQUE NONCLUSTERED INDEX UX_D_BUSINESS_UNIT_ID
--        ON Oracle_Reporting_P2.svo.D_BUSINESS_UNIT (BUSINESS_UNIT_ID)
