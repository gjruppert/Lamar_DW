/* =========================================================
   ...
   matching OneOff/10_LINES_CODE_COMBO_LOOKUP.sql so F_GL_LINES gets correct COMPANY_SK/ACCOUNT_SK.
...
BEGIN
    ...
    BEGIN TRY
        ...
        /* Full reload when building from scratch: load ALL code combinations (no watermark filter), same as OneOff. */
