...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            VALUES
            (0, -1, 'Unknown', 0, 10101, 10101, 'UNK', 'UNK', 'UNK', 'U', 'U', 10101, 0, 0, 0, 0, 'UNK', 10101, 'U', 'UNK', 'UNK', NULL, CAST(GETDATE() AS DATE), CAST(GETDATE() AS DATE));
        ...
        SELECT
            ...
            CAST(ISNULL(H.AddDateTime, GETDATE()) AS DATE) AS BZ_LOAD_DATE,
