...
BEGIN
    ...
    SELECT @TableBridgeID = TableBridgeID FROM meta.MedallionTableBridge WHERE targettable = N'GL_LegalEntityExtractPVO';
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            (0, -1, -1, -1, 'NULL', '00-0000000', 'Unknown', -1, -1, 'NULL', 'NULL', '0001-01-01', 'Unknown', 'Unknown',
             CAST('1900-01-01' AS DATETIME), GETDATE(), @AsOfDate, @HighDate, @LoadDttm, @LoadDttm, 'Y');
        ...
        (
            SELECT
                ...
                COALESCE(L.AddDateTime, SYSDATETIME()) AS BZ_LOAD_DATE,
    ...
    BEGIN CATCH
        ...
        IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'UX_D_LEGAL_ENTITY_BK_CURR' AND object_id = OBJECT_ID('svo.D_LEGAL_ENTITY'))
            CREATE UNIQUE NONCLUSTERED INDEX UX_D_LEGAL_ENTITY_BK_CURR ON svo.D_LEGAL_ENTITY(LEGAL_ENTITY_ID) WHERE CURR_IND = 'Y' ON FG_SilverDim;
        ;THROW;
    END CATCH
END;
GO
