...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            VALUES
            (0, -1, '-1', 'Unknown item', 'Unknown', 'Unknown', CAST(GETDATE() AS DATE), CAST(GETDATE() AS DATE), 'Y', @AsOfDate, @HighDate, @LoadDttm, @LoadDttm, 'Y');
        ...
        (
            SELECT
                ...
                COALESCE(CAST(I.AddDateTime AS DATE), CAST(GETDATE()-1 AS DATE)) AS BZ_LOAD_DATE,
