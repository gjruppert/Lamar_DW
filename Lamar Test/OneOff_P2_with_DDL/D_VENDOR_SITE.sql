...
IF OBJECT_ID('Oracle_Reporting_P2.svo.D_VENDOR_SITE','U') IS NOT NULL
    DROP TABLE Oracle_Reporting_P2.svo.D_VENDOR_SITE;
GO

CREATE TABLE Oracle_Reporting_P2.svo.D_VENDOR_SITE(
...
TRUNCATE TABLE Oracle_Reporting_P2.svo.D_VENDOR_SITE;
GO

/* Plug row */
SET IDENTITY_INSERT [svo].D_VENDOR_SITE ON;

INSERT INTO Oracle_Reporting_P2.svo.D_VENDOR_SITE
(
    VENDOR_SITE_SK,
    VENDOR_SITE_ID,
    VENDOR_ID,
...
/* Type 1 load from DW_BronzeSilver_PROD.bzo.AP_SupplierSitePVO */
SET XACT_ABORT ON;
BEGIN TRAN;
...
(
    ...
    FROM DW_BronzeSilver_PROD.bzo.AP_SupplierSitePVO
    WHERE VendorSiteId IS NOT NULL
)
MERGE Oracle_Reporting_P2.svo.D_VENDOR_SITE AS D
USING S
