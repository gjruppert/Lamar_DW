...
BEGIN
    ...
    BEGIN TRY
        ...
        INSERT INTO svo.F_GL_BALANCES WITH (TABLOCK)
        ...
        SELECT
            ...
            CAST(ISNULL(B.BalanceBeginBalanceDr, 0) - ISNULL(B.BalanceBeginBalanceCr, 0) AS decimal(29,4)),
            CAST(ISNULL(B.BalancePeriodNetDr, 0) - ISNULL(B.BalancePeriodNetCr, 0) AS decimal(29,4)),
            CAST((ISNULL(B.BalanceBeginBalanceDr, 0) - ISNULL(B.BalanceBeginBalanceCr, 0)) + (ISNULL(B.BalancePeriodNetDr, 0) - ISNULL(B.BalancePeriodNetCr, 0)) AS decimal(29,4)),
