...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            VALUES
            (0, -1, 'Unknown', -1, 'UNK', -1, 'UNK', 'UNK', 'UNK', 'UNK', 'Unknown', 'Unknown', '1753-01-01', '0001-01-01', '0001-01-01', -1, '0001-01-01', CAST(GETDATE() AS DATE),
        ...
        (
            SELECT
                ...
                COALESCE(CAST(B.AddDateTime AS DATE), CAST('0001-01-01' AS DATE)) AS BZ_LOAD_DATE,
