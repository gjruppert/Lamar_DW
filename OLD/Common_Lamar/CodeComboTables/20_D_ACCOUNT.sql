...
SELECT
    ...
    CAST(H1.AddDateTime AS DATE) AS BZ_LOAD_DATE,
...
INNER JOIN bzo.GL_ValueSetValuesPVO lvl1 ON lvl1.VALUE = h1.DEP31PK1VALUE AND lvl1.ATTRIBUTECATEGORY = 'ACCOUNT LAMAR'
INNER JOIN bzo.GL_ValueSetValuesPVO lvl2 ON lvl2.VALUE = h1.DEP30PK1VALUE AND lvl2.ATTRIBUTECATEGORY = 'ACCOUNT LAMAR'
INNER JOIN bzo.GL_ValueSetValuesPVO lvl3 ON lvl3.VALUE = h1.DEP29PK1VALUE AND lvl3.ATTRIBUTECATEGORY = 'ACCOUNT LAMAR'
INNER JOIN bzo.GL_ValueSetValuesPVO lvl4 ON lvl4.VALUE = h1.DEP28PK1VALUE AND lvl4.ATTRIBUTECATEGORY = 'ACCOUNT LAMAR'
INNER JOIN bzo.GL_ValueSetValuesPVO lvl5 ON lvl5.VALUE = h1.DEP27PK1VALUE AND lvl5.ATTRIBUTECATEGORY = 'ACCOUNT LAMAR'
INNER JOIN bzo.GL_ValueSetValuesPVO lvl6 ON lvl6.VALUE = h1.DEP26PK1VALUE AND lvl6.ATTRIBUTECATEGORY = 'ACCOUNT LAMAR'
INNER JOIN bzo.GL_ValueSetValuesPVO lvl7 ON lvl7.VALUE = h1.DEP25PK1VALUE AND lvl7.ATTRIBUTECATEGORY = 'ACCOUNT LAMAR'
INNER JOIN bzo.GL_ValueSetValuesPVO lvl8 ON lvl8.VALUE = h1.DEP24PK1VALUE AND lvl8.ATTRIBUTECATEGORY = 'ACCOUNT LAMAR'
RIGHT JOIN bzo.GL_ValueSetValuesPVO lvl9 ON lvl9.VALUE = h1.DEP0PK1VALUE AND lvl9.ATTRIBUTECATEGORY = 'ACCOUNT LAMAR'
...
BEGIN
    ...
    INSERT INTO svo.D_ACCOUNT (ACCOUNT_SK,ACCOUNT_ID,ACCOUNT_LVL1_CODE,ACCOUNT_LVL1_DESC,ACCOUNT_LVL2_CODE,
