...
--   ================================ */
IF OBJECT_ID('Oracle_Reporting_P2.svo.F_GL_BALANCES','U') IS NOT NULL DROP TABLE Oracle_Reporting_P2.svo.F_GL_BALANCES;
GO

CREATE TABLE Oracle_Reporting_P2.[svo].[F_GL_BALANCES](
...
TRUNCATE TABLE Oracle_Reporting_P2.svo.F_GL_BALANCES;
GO

INSERT INTO Oracle_Reporting_P2.svo.F_GL_BALANCES (
    ACCOUNT_SK, 
...
FROM  [DW_BronzeSilver_PROD].[bzo].[GL_BalanceExtractPVO] AS B
LEFT JOIN [DW_BronzeSilver_PROD].[bzo].[GL_FiscalPeriodExtractPVO] P ON B.[BalancePeriodName] = P.[PeriodPeriodName]
...
LEFT JOIN Oracle_Reporting_P2.svo.D_LEDGER             AS LDG ON LDG.LEDGER_ID            = B.BalanceLedgerId
