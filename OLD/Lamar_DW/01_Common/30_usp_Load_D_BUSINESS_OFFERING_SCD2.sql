...
BEGIN
    ...
    BEGIN TRY
        ...
        /* ===== Source (incremental + dedup by BUSINESS_OFFERING_ID) ===== */
        ...
        (
            SELECT
                ...
                ROW_NUMBER() OVER
                (
                    PARTITION BY ISNULL(LTRIM(RTRIM(lvl5.VALUE)),'-1')
                    ORDER BY
                        (SELECT MAX(v.dt)
                         FROM (VALUES
                                (h1.AddDateTime),
            ...
            RIGHT JOIN bzo.GL_ValueSetValuesPVO lvl5
                ON lvl5.VALUE = h1.DEP0PK1VALUE
               AND lvl5.ATTRIBUTECATEGORY = 'BUSINESS OFFERING LAMAR'
            WHERE
                lvl5.ATTRIBUTECATEGORY = 'BUSINESS OFFERING LAMAR'
                ...
                (
                    ...
                    lvl5.AddDateTime > @LastWatermark
                )
        ) s
        WHERE s.rn = 1;
        ...
        INNER JOIN #src src
            ON src.BUSINESS_OFFERING_ID = tgt.BUSINESS_OFFERING_ID
        ...
        SELECT
            src.BUSINESS_OFFERING_ID,
            src.BUSINESS_OFFERING_LVL1_CODE,
            src.BUSINESS_OFFERING_LVL1_DESC,
            src.BUSINESS_OFFERING_LVL2_CODE,
            src.BUSINESS_OFFERING_LVL2_DESC,
            src.BUSINESS_OFFERING_LVL3_CODE,
            src.BUSINESS_OFFERING_LVL3_DESC,
            src.BUSINESS_OFFERING_LVL4_CODE,
            src.BUSINESS_OFFERING_LVL4_DESC,
            src.BUSINESS_OFFERING_LVL5_CODE,
            src.BUSINESS_OFFERING_LVL5_DESC,
            src.BUSINESS_OFFERING_DISTANCE,
            src.BUSINESS_OFFERING_CATEGORY,
            src.BUSINESS_OFFERING_ENABLED_FLAG,
            ...
            'Y'
        FROM #src src
        LEFT JOIN svo.D_BUSINESS_OFFERING tgt
            ON tgt.BUSINESS_OFFERING_ID = src.BUSINESS_OFFERING_ID
           AND tgt.CURR_IND = 'Y'
