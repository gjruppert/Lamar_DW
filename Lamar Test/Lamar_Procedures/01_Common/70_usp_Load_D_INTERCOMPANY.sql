    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            (INTERCOMPANY_SK, INTERCOMPANY_ID, INTERCOMPANY_LVL1_CODE, INTERCOMPANY_LVL1_DESC, INTERCOMPANY_LVL2_CODE, INTERCOMPANY_LVL2_DESC,
             INTERCOMPANY_LVL3_CODE, INTERCOMPANY_LVL3_DESC, INTERCOMPANY_DISTANCE, INTERCOMPANY_CATEGORY, INTERCOMPANY_ENABLED_FLAG,
            ...
            VALUES
            (0,'-1','-1','Unknown','-1','Unknown','-1','Unknown',0,'Missing',NULL,'0001-01-01','9999-12-31','SYSTEM','2025-10-18',CAST(GETDATE() AS DATE),CAST(GETDATE() AS DATE),
        ...
        SELECT
            ...
            src.INTERCOMPANY_LVL3_CODE, src.INTERCOMPANY_LVL3_DESC, src.INTERCOMPANY_DISTANCE, src.INTERCOMPANY_CATEGORY, src.INTERCOMPANY_ENABLED_FLAG,
