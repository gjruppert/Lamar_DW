...
JOIN bzo.GL_FiscalPeriodExtractPVO P
...
/* =========================
   ...
   ========================= */
IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'UX_D_CALENDAR_DATE_BK' AND object_id = OBJECT_ID('svo.D_CALENDAR'))
BEGIN
    CREATE UNIQUE NONCLUSTERED INDEX UX_D_CALENDAR_DATE_BK ON svo.D_CALENDAR(DATE_SK) ON FG_SilverDim;
END
