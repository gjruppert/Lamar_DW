...
BEGIN
    ...
    SELECT @TableBridgeID = TableBridgeID FROM meta.MedallionTableBridge WHERE targettable = N'GL_DailyRateExtractPVO';
    ...
    BEGIN TRY
        ...
        IF EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'UX_D_CURRENCY_ID' AND object_id = OBJECT_ID('svo.D_CURRENCY'))
            DROP INDEX UX_D_CURRENCY_ID ON svo.D_CURRENCY;
        ...
        BEGIN
            ...
            VALUES (0, '-1', 'UNK', 'UNK', '0001-01-01', 1, 'UNK', 'U', '0001-01-01', GETDATE());
