    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            (
                COMPANY_SK,
                COMPANY_ID,
                COMPANY_LVL1_CODE, COMPANY_LVL1_DESC,
                COMPANY_LVL2_CODE, COMPANY_LVL2_DESC,
                COMPANY_LVL3_CODE, COMPANY_LVL3_DESC,
                COMPANY_LVL4_CODE, COMPANY_LVL4_DESC,
                COMPANY_LVL5_CODE, COMPANY_LVL5_DESC,
                COMPANY_LVL6_CODE, COMPANY_LVL6_DESC,
                COMPANY_LVL7_CODE, COMPANY_LVL7_DESC,
                COMPANY_DISTANCE,
                COMPANY_CATEGORY,
        ...
        /* ===== Source (incremental + dedup by COMPANY_ID) ===== */
        IF OBJECT_ID('tempdb..#src') IS NOT NULL
            DROP TABLE #src;

        SELECT
            s.COMPANY_ID,
            s.COMPANY_LVL1_CODE, s.COMPANY_LVL1_DESC,
            s.COMPANY_LVL2_CODE, s.COMPANY_LVL2_DESC,
            s.COMPANY_LVL3_CODE, s.COMPANY_LVL3_DESC,
            s.COMPANY_LVL4_CODE, s.COMPANY_LVL4_DESC,
            s.COMPANY_LVL5_CODE, s.COMPANY_LVL5_DESC,
            s.COMPANY_LVL6_CODE, s.COMPANY_LVL6_DESC,
            s.COMPANY_LVL7_CODE, s.COMPANY_LVL7_DESC,
            s.COMPANY_DISTANCE,
            s.COMPANY_CATEGORY,
        ...
        (
            SELECT
                ...
                ROW_NUMBER() OVER
                (
                    PARTITION BY ISNULL(LTRIM(RTRIM(lvl7.VALUE)),'-1')
                    ORDER BY
                        (SELECT MAX(v.dt)
                         FROM (VALUES
                                (h1.AddDateTime),
            ...
            RIGHT JOIN bzo.GL_ValueSetValuesPVO lvl7
                ON lvl7.VALUE = h1.DEP0PK1VALUE
               AND lvl7.ATTRIBUTECATEGORY = 'COMPANY LAMAR'
            WHERE
                lvl7.ATTRIBUTECATEGORY = 'COMPANY LAMAR'
                ...
                (
                    ...
                    lvl7.AddDateTime > @LastWatermark
                )
        ) s
        WHERE s.rn = 1;
        ...
        SELECT
            src.COMPANY_ID,
            src.COMPANY_LVL1_CODE, src.COMPANY_LVL1_DESC,
            src.COMPANY_LVL2_CODE, src.COMPANY_LVL2_DESC,
            src.COMPANY_LVL3_CODE, src.COMPANY_LVL3_DESC,
            src.COMPANY_LVL4_CODE, src.COMPANY_LVL4_DESC,
            src.COMPANY_LVL5_CODE, src.COMPANY_LVL5_DESC,
            src.COMPANY_LVL6_CODE, src.COMPANY_LVL6_DESC,
            src.COMPANY_LVL7_CODE, src.COMPANY_LVL7_DESC,
            src.COMPANY_DISTANCE,
            src.COMPANY_CATEGORY,
            src.COMPANY_ENABLED_FLAG,
