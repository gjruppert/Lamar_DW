...
BEGIN
    ...
    SELECT @TableBridgeID = TableBridgeID FROM meta.MedallionTableBridge WHERE targettable = N'F_AP_PAYMENTS';
    ...
    BEGIN TRY
        ...
        IF EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_F_AP_AGING_SNAPSHOT_SNAPDT_ACCTSK_ETC' AND object_id = OBJECT_ID('svo.F_AP_AGING_SNAPSHOT'))
            DROP INDEX IX_F_AP_AGING_SNAPSHOT_SNAPDT_ACCTSK_ETC ON svo.F_AP_AGING_SNAPSHOT;
        ...
        IF NOT EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'IX_F_AP_AGING_SNAPSHOT_SNAPDT_ACCTSK_ETC' AND object_id = OBJECT_ID('svo.F_AP_AGING_SNAPSHOT'))
            ...
            INCLUDE (ORIGINAL_AMOUNT, AMOUNT_PAID, AMOUNT_REMAINING, DAYS_PAST_DUE, AGING_BUCKET_CODE) ON FG_SilverFact;
