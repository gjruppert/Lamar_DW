...
:r Lamar_Procedures/02_AP/30_usp_Load_STG_AP_INVOICE_LINE_DISTRIBUTION.sql
:r Lamar_Procedures/02_AP/35_usp_Load_F_AP_INVOICE_LINE_DISTRIBUTION.sql
...
PRINT '--- 06_SL ---';
GO
:r Lamar_Procedures/06_SL/30_usp_Load_F_SL_JOURNAL_DISTRIBUTION.sql
PRINT '--- 07_RM ---';
GO
...
PRINT '=== (4/4) Indexes ===';
PRINT 'Indexes are defined and created by load procedures (drop at start for full reload, create at end). Create_Indexes.sql is a stub.';
