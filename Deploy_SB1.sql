/* =========================================================
   Deploy for Sandbox1 (SANDBOX1) – same order as Deploy.sql, run from Code directory.
   Paths: Lamar_Procedures, Lamar_Index. Server: SANDBOX1.
   Example: sqlcmd -S SANDBOX1 -d DW_BronzeSilver_DEV1 -i Deploy_SB1.sql
   Or run Deploy_SB1.bat from the Code directory.
   ========================================================= */
