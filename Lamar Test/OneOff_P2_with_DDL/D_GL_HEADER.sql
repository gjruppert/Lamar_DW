...
END 
    ...
    LEFT JOIN [Oracle_Reporting_P2].[DW_BronzeSilver_PROD].[bzo].[GL_JournalCategoryExtractPVO] cat on H.GlJeHeadersJeCategory = cat.JournalCategoryJeCategoryName
	LEFT JOIN [Oracle_Reporting_P2].[DW_BronzeSilver_PROD].[bzo].[GL_JournalSourceExtractPVO] src on H.GlJeHeadersJeSource = src.JournalSourceJeSourceName;
 GO
