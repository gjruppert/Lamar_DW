...
BEGIN
    ...
    SELECT @TableBridgeID = TableBridgeID FROM meta.MedallionTableBridge WHERE targettable = N'GL_FiscalDayPVO';
    ...
    BEGIN TRY
        ...
        IF EXISTS (SELECT 1 FROM sys.indexes WHERE name = 'UX_D_CALENDAR_DATE' AND object_id = OBJECT_ID('svo.D_CALENDAR'))
            DROP INDEX UX_D_CALENDAR_DATE ON svo.D_CALENDAR;
        ...
        BEGIN
            ...
            VALUES (10101, '0001-01-01', NULL, NULL, 'Unknown', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Unknown', NULL, NULL, NULL, NULL, SYSDATETIME(), SYSDATETIME());
        END;
        IF NOT EXISTS (SELECT 1 FROM svo.D_CALENDAR WHERE DATE_SK = 99991231)
        BEGIN
            INSERT INTO svo.D_CALENDAR (DATE_SK, DATE, DAY_OF_WEEK, PERIOD_NUMBER, PERIOD_NAME, PERIOD_START_DATE, PERIOD_END_DATE, QUARTER_NUMBER, QUARTER_START_DATE, QUARTER_END_DATE, YEAR_NUMBER, YEAR_START_DATE, YEAR_END_DATE, JULIAN_DATE, PERIOD_TYPE, LAST_UPDATE_DATE, OBJECT_VERSION_NUMBER, CALENDAR_ID, GL_CALENDARS_USER_PERIOD_SET_NAME, BZ_LOAD_DATE, SV_LOAD_DATE)
            VALUES (99991231, '9999-12-31', NULL, NULL, 'Unknown', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Unknown', NULL, NULL, NULL, NULL, SYSDATETIME(), SYSDATETIME());
        END;
