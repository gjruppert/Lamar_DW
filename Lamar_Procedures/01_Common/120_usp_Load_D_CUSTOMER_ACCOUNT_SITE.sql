...
BEGIN
    ...
    SELECT @TableBridgeID = TableBridgeID FROM meta.MedallionTableBridge WHERE targettable = N'AR_CustomerAccountSiteExtractPVO';
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            VALUES
            (0, -1, -1, -1, 'U', GETDATE(), GETDATE(), @AsOfDate, @HighDate, @LoadDttm, @LoadDttm, 'Y');
