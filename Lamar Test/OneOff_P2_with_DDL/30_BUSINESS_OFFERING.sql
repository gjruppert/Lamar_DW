...
/* =================
   BUSINESS_OFFERING
   ================= */
IF OBJECT_ID(N'Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING', 'U') IS NOT NULL
    DROP TABLE Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING;
GO

CREATE TABLE Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING
(
...
TRUNCATE TABLE Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING;
GO

INSERT INTO Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING (
...
INNER JOIN DW_BronzeSilver_PROD.bzo.GL_ValueSetValuesPVO lvl1 ON lvl1.VALUE = h1.DEP31PK1VALUE AND lvl1.ATTRIBUTECATEGORY = 'BUSINESS OFFERING LAMAR'
INNER JOIN DW_BronzeSilver_PROD.bzo.GL_ValueSetValuesPVO lvl2 ON lvl2.VALUE = h1.DEP30PK1VALUE AND lvl2.ATTRIBUTECATEGORY = 'BUSINESS OFFERING LAMAR'
INNER JOIN DW_BronzeSilver_PROD.bzo.GL_ValueSetValuesPVO lvl3 ON lvl3.VALUE = h1.DEP29PK1VALUE AND lvl3.ATTRIBUTECATEGORY = 'BUSINESS OFFERING LAMAR'
INNER JOIN DW_BronzeSilver_PROD.bzo.GL_ValueSetValuesPVO lvl4 ON lvl4.VALUE = h1.DEP28PK1VALUE AND lvl4.ATTRIBUTECATEGORY = 'BUSINESS OFFERING LAMAR'
RIGHT JOIN DW_BronzeSilver_PROD.bzo.GL_ValueSetValuesPVO lvl5 ON lvl5.VALUE = h1.DEP0PK1VALUE AND lvl5.ATTRIBUTECATEGORY = 'BUSINESS OFFERING LAMAR'
WHERE lvl5.ATTRIBUTECATEGORY = 'BUSINESS OFFERING LAMAR' AND lvl5.SUMMARYFLAG = 'N'
--and ISNULL(TRIM(lvl5.VALUE),'-1') = '214'
GO

	
--IF EXISTS (SELECT 1 FROM Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING  WHERE (BUSINESS_OFFERING_ID = '-1') ) DELETE FROM Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING  WHERE (BUSINESS_OFFERING_ID = '-1');
...
IF NOT EXISTS (SELECT 1 FROM Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING WHERE BUSINESS_OFFERING_SK = 0)
BEGIN
    SET IDENTITY_INSERT Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING ON;

    INSERT INTO Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING(BUSINESS_OFFERING_SK,BUSINESS_OFFERING_ID,BUSINESS_OFFERING_LVL1_CODE,
    ...
    SET IDENTITY_INSERT Oracle_Reporting_P2.svo.D_BUSINESS_OFFERING OFF;
END
GO
