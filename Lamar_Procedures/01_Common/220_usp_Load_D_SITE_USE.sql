...
BEGIN
    ...
    SELECT @TableBridgeID = TableBridgeID FROM meta.MedallionTableBridge WHERE targettable = N'AR_CustomerAcctSiteUseExtractPVO';
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            VALUES
            (0, -1, -1, 'UNK', NULL, NULL, NULL, 'U', GETDATE(), GETDATE(), @AsOfDate, @HighDate, @LoadDttm, @LoadDttm, 'Y');
