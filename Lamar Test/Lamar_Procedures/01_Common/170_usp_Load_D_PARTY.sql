...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            VALUES
            (0, -1, 'UNK', 'Unknown', 'U', 'U', 'UNK', 'UN', 'UNK', '00000', 'System', CAST(GETDATE() AS DATE), CAST(GETDATE() AS DATE),
             CAST(GETDATE() AS DATE), CAST(GETDATE() AS DATE), @AsOfDate, @HighDate, @LoadDttm, @LoadDttm, 'Y');
